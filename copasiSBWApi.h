...
*/
<<<<<<< .mine
TCAPIEXPORT tc_matrix cGetReactionRatesEx(tc_matrix rates);
=======
...
*/
<<<<<<< .mine
TCAPIEXPORT tc_matrix cGetRatesOfChange(copasi_model model);
=======
TCAPIEXPORT void cSetFloatingSpeciesIntitialConcentrations (copasi_model model, tc_matrix sp);
>>>>>>> .r96
...
*/
TCAPIEXPORT double cGetRateOfChange(copasi_model model, int index);
...
<<<<<<< .mine
 ...
 \ingroup state
*/
TCAPIEXPORT tc_strings cGetAllSpeciesNames(copasi_model model);
...
*/
<<<<<<< .mine
TCAPIEXPORT tc_strings cGetGlobalParameterNames (copasi_model);
=======
...
/*! 
 ...
 \ingroup compartment
*/
TCAPIEXPORT tc_strings cGetCompartmentNames (copasi_model);
=======
>>>>>>> .r96
