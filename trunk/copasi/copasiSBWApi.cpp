...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_matrix cGetNumberOfReactions (copasi_model model)
{
	  return tc_createMatrix (0, 0);
}
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_strings cGetReactionNames (copasi_model model)
=======
...
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT int cGetReactionRate(copasi_model model, int index)
{
	return 0;
}

// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_matrix getReactionRatesEx(tc_matrix values)
{
  return tc_createMatrix (0, 0);	
}
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_strings cGetFloatingSpeciesNames(copasi_model model)
{
	return tc_createStringsArray(0);
}
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_strings cGetBoundarySpeciesNames(copasi_model model)
{
	return tc_createStringsArray(0);
}
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT int cGetNumberFloatingSpecies(copasi_model model)
{
	return 0;
=======
	return res;
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT void cSetFloatingSpeciesByIndex (copasi_model model, int index)
{
}
=======
	const CCopasiVector< CMetab > & species = pModel->getMetabolites();
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT double cGetFloatingSpeciesByIndex (copasi_model model, int index)
{
	return 0.0;
=======
	int n = 0;
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT void cSetFloatingSpeciesConcentrations (copasi_model model, tc_matrix sp)
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_matrix cGetFloatingSpeciesConcentrations (copasi_model model)
{
	return tc_createMatrix (0, 0);
=======
	const CCopasiVector< CMetab > & species = pModel->getMetabolites();
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT void cSetFloatingSpeciesIntitialConcentrationByIndex (copasi_model model, int index, double sp)
=======
TCAPIEXPORT int cGetNumberOfBoundarySpecies(copasi_model model)
>>>>>>> .r96
{
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT void cSetBoundarySpeciesByIndex (copasi_model model, int index)
=======
	int n = 0;
	for (int i=0; i < species.size(); ++i)
		if (species[i] && 
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT double cGetBoundarySpeciesByIndex (copasi_model model, int index)
{
	return 0.0;
=======
	const CCopasiVector< CMetab > & species = pModel->getMetabolites();
...
<<<<<<< .mine
TCAPIEXPORT tc_matrix cGetBoundarySpeciesConcentrations (copasi_model model)
=======
TCAPIEXPORT void cSetBoundarySpeciesConcentrations (copasi_model model, tc_matrix d)
>>>>>>> .r96
{
...
<<<<<<< .mine
	tc_strings res  = tc_createStringsArray(species.size());
=======
...
TCAPIEXPORT tc_strings cGetRatesOfChangeNames(copasi_model model)
{
	return tc_createStringsArray(0);
}
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT int cGetNumberOfGlobalParameters (copasi_model model)
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_strings cGetGlobalParameterNames (copasi_model model)
{
	return tc_createStringsArray(0);
}
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT double cGetGlobalParameterByIndex (copasi_model model, int index)
{
	 return 0.0;
}
=======
...
TCAPIEXPORT int cGetNumberOfCompartments (copasi_model model)
=======
...
<<<<<<< .mine
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT tc_strings cGetCompartmentNames (copasi_model model)
=======
...
// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT double cGetCompartmentByIndex (copasi_model model, int index)
{
	 return 0.0;
}

// STUB: NEEDS TO BE IMPLEMENTED
TCAPIEXPORT void cSetCompartmentByIndex (copasi_model model, int index, double value)
{
